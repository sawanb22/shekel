      ...
      */}
      <div className="mx-auto flex w-full flex-col">
        <div className="flex flex-col gap-12 px-6 py-14 md:px-[84px] lg:flex-row lg:justify-between lg:gap-16 lg:py-[87px]">
          ...
          <div className="grid w-full max-w-[547px] grid-cols-2 gap-x-8 gap-y-10 md:grid-cols-4 md:gap-x-[49px]">
        ...
        <div className="flex h-auto w-full flex-col gap-3 border-t border-[rgba(198,198,199,0.2)] px-6 py-8 md:h-[82px] md:flex-row md:items-center md:justify-between md:px-20 md:py-0">
